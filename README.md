# Evil Genius Creative Reactfolio V1.2 👩🏽‍🚀

## Highly Modified Version of Reactfolio from Tharindu N. Madhusanka by Ian Kleinfeld

We at Evil Genius Creative chose ReactFolio as our website portfolio base, because it is a modern and personal portfolio web template built using the React library, our specialty&#151;along with Vanilla Javascript. Because of its codebase, we found it easy to modify many elements to our needs. It provides an easy way for our developers, designers, and creatives to showcase their work, skills, and achievements in a professional and visually appealing way. With its responsive design and clean code, we have highly tailored it to suit our needs and preferences in a way that makes it our own, without havin to spend 100+ hours to do so.

We're sure you're wondering, "So why didn't we build our own from scratch?" Becuase the tailor's children have no shoes. Our clients' work comes first, and since creating a portfolio from scratch is a time-consuming process, we chose to use ReactFolio as our portfolio base so we could focus on delivering the best possible experience for our clients.
